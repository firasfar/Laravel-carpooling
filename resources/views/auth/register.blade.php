    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div>
             ...
             <!-- update -->
             <div>
                <x-label for="image" :value="__('Choose a profile picture:')" />

                <x-input id="image" class="block mt-1 w-full" type="file" name="image" accept="image/png,image/jpg,image/jpeg " required autofocus />
            </div>
            <!-- Email Address -->
            <div class="mt-4">
